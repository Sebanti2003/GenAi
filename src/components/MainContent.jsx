...
import geminiLogo from "../assets/194915 - Copy.png"
...
const MainContent = () => {
  ...
  return (
    <div className="flex-1 min-h-screen pb-[15vh] relative">
      <div className="flex items-center justify-between text-xl p-5 text-slate-10000">
        <p><p style={{ fontWeight: 'bold' }}>MIRA AI by GENTECH</p></p>
        <FaUserCircle />
      </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-5">
              <div className="h-[200px] p-4 bg-gray-200 rounded-lg relative cursor-pointer hover:bg-gray-300">
                ...
                Remember to take care of yourself, both physically and mentally. You deserve it!
                </p>
              ...
              <div className="h-[200px] p-4 bg-gray-200 rounded-lg relative cursor-pointer hover:bg-gray-300">
                <p className="text-slate-700 text-lg">
                Embrace the present moment and find joy in the little things around you.
                </p>
              ...
              <div className="h-[200px] p-4 bg-gray-200 rounded-lg relative cursor-pointer hover:bg-gray-300">
                <p className="text-slate-700 text-lg">
                You are capable of incredible things, and your potential is limitless.
                </p>
